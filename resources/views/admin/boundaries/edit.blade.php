    ...
    <div class="py-10">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-2xl p-6">
                <form x-data="{ area: '' }" @area-calculated.window="area = $event.detail; $refs.areaInput.value = area" action="{{ route('admin.boundaries.update', $boundary) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input x-ref="areaInput" type="number" name="area_hectares" value="{{ old('area_hectares', $boundary->area_hectares) }}" step="0.0001" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">
