    ...
    <div class="py-10">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-2xl p-6">
                <form x-data="{ area: '' }" @area-calculated.window="area = $event.detail; $refs.areaInput.value = area" action="{{ route('admin.land-uses.update', $landUse) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
